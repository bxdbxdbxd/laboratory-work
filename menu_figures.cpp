...
int main() {
    ...
    switch(figure_option) {
        case 1:
            ...
            cout << "\nPerimeter: " << Perimetr(array_of_sides[0], array_of_sides[1]) << "\nSquare: " << Square(array_of_sides[0], array_of_sides[1]) << "\nDiagonal: " << Diagonal(array_of_sides[0], array_of_sides[1]) << endl << endl;
            break;
        case 2:
            ...
            if (firstParties + secondParties > thirdParties && firstParties + thirdParties > secondParties && secondParties + thirdParties > firstParties) {
                ...
                if (checkIsosceles(firstParties,secondParties,thirdParties)) {
                    cout<<"Triangle is isosceles"<<endl << endl;
                } else{
                    cout<<"Triangle is not isosceles"<<endl << endl;
                }
            } else{
                cout<<"\nUNCORRECT\n";
            }
        ...
        case 3:
            ...
            cout << "\nPerimeter: " << trapezoid_perimeter(array_of_sides) << "\nSquare: " << area_of_trapezoid(array_of_sides) << "\nMidline lenth: " << midline_lenth(array_of_sides) << endl << endl;
            break;
    }
